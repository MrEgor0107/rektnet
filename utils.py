...
def calculate_mean_distance(epoch_kpt_dis):
    ...
    return [top,first_L_top,first_R_top,first_L_bot,first_L_bot,second_L_top,second_R_top,second_L_top,second_L_bot,second_R_bot,bot_L,bot_R],total,[top_std,first_L_top_std,first_R_top_std,first_L_bot_std,first_L_bot_std,second_L_top_std,second_R_top_std,second_L_top_std,second_L_bot_std,second_R_bot_std,bot_L_std,bot_R_std]
